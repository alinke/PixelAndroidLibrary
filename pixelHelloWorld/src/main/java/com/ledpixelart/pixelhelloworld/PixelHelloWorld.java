...
public class PixelHelloWorld extends IOIOActivity   {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main);
	   	...
	   	KIND = ioio.lib.api.RgbLedMatrix.Matrix.ADAFRUIT_32x32; //we are hard coding the matrix type here, normally you would let the user select the matrix type in preferences so you can support multiple led panel types
